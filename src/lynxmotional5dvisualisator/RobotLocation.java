...
public class RobotLocation
{
    ...
    /** real lengths of arm parts in millimeters */
    public static final double RAMENO = 14.605 * 10;
    public static final double PREDLAKTIE = 18.7325 * 10;
    public static final double ZAPASTIE = 8.5725 * 10;
    ...
    public RobotLocation(String locations) throws Exception
    {
        ...
        if (angs.length == angles.length) {
            ...
            for(int i = 0; i< angles.length; i++) {
                if(i < 5) {
                    angles[i] = anglesBottomPosition[i];
                }
                else {
                    angles[i] = anglesUpperPosition[i-5];
                }
            }
        }
        else {
    ...
    public double[] getAnglesFromCoordinates(double x, double y, double z) throws Exception{
        ...
        double pointCX = x;
        double pointCY = y;
        double pointCZ = z + UPPER_FIELD_POSITION;
